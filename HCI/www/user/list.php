...
$sql = "SELECT user_id, user_name, user_regdate, user_last_login, user_fname, user_lname, user_position
        FROM tbl_user where user_name like '%$search%' or user_fname like '%$search%' or user_lname like '%$search%'";
$result = dbQuery($sql);
...
?>
  ...
  <tr> 
   ...
   <div class="content"><input name="btnAddUser" type="button"  value="Add User" class="form-add" onClick="addUser()"></div></td>
  </tr>
 </table>

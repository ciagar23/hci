...
<div class="nav-outer"> 
		...
		<div id="nav-right">
			...
			<div class="showhide-account"><img src="<?php echo WEB_ROOT;?>admin/include/images/shared/nav/nav_myaccount.gif" width="93" height="14" alt="" /></div>
			<div class="nav-divider">&nbsp;</div>
			<a href="<?php echo $self; ?>?logout" id="logout"><img src="<?php echo WEB_ROOT;?>admin/include/images/shared/nav/nav_logout.gif" width="64" height="14" alt="" /></a>
			<div class="clear">&nbsp;</div>
        ...
        <? if ($position=='ADMIN' || $position=='ENCODER'){?>
		...
		<ul class="select"><li><a href="<?php echo WEB_ROOT; ?>admin/medicine/"><b>Medicine</b><!--[if IE 7]><!--></a><!--<![endif]-->
			...
			<div class="nav-divider">&nbsp;</div>
<ul class="select"><li><a href="<?php echo WEB_ROOT; ?>admin/medicalrecords"><b>Medical Records</b><!--[if IE 7]><!--></a><!--<![endif]-->
		...
		<ul class="select"><li><a href="<?php echo WEB_ROOT; ?>admin/tour"><b>Tours</b><!--[if IE 7]><!--></a><!--<![endif]-->
 ...
 <? if ($position=='ENCODER'){?>
		...
		<ul class="select"><li><a href="#nogo"><b> Encode</b><!--[if IE 7]><!--></a><!--<![endif]-->

		</ul>
<? }else{}?>

 <? if ($position=='STUDENT' || $position=='FACULTY'){?>
		<div class="nav-divider">&nbsp;</div>            
		<ul class="select"><li><a href="<?php echo WEB_ROOT; ?>admin/profile/"><b> Profile</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<div class="nav-divider">&nbsp;</div> </ul>           
		<ul class="select"><li><a href="<?php echo WEB_ROOT; ?>admin/appointment"><b> Appointment</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<div class="nav-divider">&nbsp;</div>     </ul>       
		<ul class="select"><li><a href="<?php echo WEB_ROOT; ?>admin/myhistory"><b> My History</b><!--[if IE 7]><!--></a><!--<![endif]-->
...
<? }else{}?>
 <? if ($position=='FACULTY'){?>
		<div class="nav-divider">&nbsp;</div>            
		<ul class="select"><li><a href="<?php echo WEB_ROOT; ?>admin/studentsAttendance"><b> Student's Attendance</b><!--[if IE 7]><!--></a><!--<![endif]-->          

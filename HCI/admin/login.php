...
<table border="0">
      <tr><td>&nbsp;
        ...
        <tr>
			<th>&nbsp;</th>
			<td><input type="text"  class="login-inp" value="ID Number"  onfocus="this.value=''"  name="txtUserName" /></td>
		</tr>
		<tr>
			<th>&nbsp;</th>
			<td><input type="password"  name="txtPassword" value="password"  onfocus="this.value=''" class="login-pw" /></td>
		</tr>
		<tr>
			<td colspan="4" align="right"><input type="image" src="include/loginbutton.png"  />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		</tr>

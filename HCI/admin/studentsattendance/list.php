...
$sql = "SELECT p_id, p_username, p_date, p_time, p_diagnosis, p_treatment, p_remarks, p_doctor, p_teacher
        FROM tbl_patient where p_confirmation =1 and  p_teacher='$session' order by p_date";
$result = dbQuery($sql);
...
<input type="hidden" name="evaluator" value="<?php echo $session;?>"  />
				  ...
				  <tr align="center" id="listTableHeader"> 
					...
					<th class="table-header-repeat line-left" align="left"><a href="">Treatment</th>
